...
--
-- Name: progetto_amassare_fzontaro; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE progetto_amassare_fzontaro WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'en_US.UTF-8';


ALTER DATABASE progetto_amassare_fzontaro OWNER TO postgres;
...
--
-- Name: addetto; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.addetto OWNER TO postgres;

--
-- Name: allacciamento; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.allacciamento OWNER TO postgres;

--
-- Name: aperturaservizio; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.aperturaservizio OWNER TO postgres;
...
--
-- Name: fattura_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.fattura_id_seq OWNER TO postgres;

--
-- Name: fattura_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: imbarcazione; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.imbarcazione OWNER TO postgres;

--
-- Name: imbarcazione_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.imbarcazione_id_seq OWNER TO postgres;

--
-- Name: imbarcazione_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: molo; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.molo OWNER TO postgres;

--
-- Name: molo_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.molo_id_seq OWNER TO postgres;

--
-- Name: molo_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: periodoapertura; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.periodoapertura OWNER TO postgres;

--
-- Name: periodoapertura_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.periodoapertura_id_seq OWNER TO postgres;

--
-- Name: periodoapertura_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: sosta; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.sosta OWNER TO postgres;

--
-- Name: sosta_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.sosta_id_seq OWNER TO postgres;

--
-- Name: sosta_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: fattura id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: imbarcazione id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: molo id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: periodoapertura id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: sosta id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Data for Name: addetto; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: allacciamento; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.allacciamento (nome, prezzounitario, unitamisura) FROM stdin;
Acqua	0.02	l
AriaCompressa	0.03	l
Elettricità	0.21	KW/h
Gas	0.32	Mc
\.


--
-- Data for Name: aperturaservizio; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
FRIFME76P50G224A	Elettricità	2022-05-26 16:12:23.622	2022-05-31 00:00:00	40	4
BRNRNS61D64G224W	Acqua	2022-05-23 16:12:23.622	2022-05-31 00:00:00	30	5
SPSLRA03M70G224G	Acqua	2022-05-25 16:12:23.622	2022-05-31 00:00:00	75	1
GLLGNN81A54G224W	Acqua	2022-05-26 16:12:23.622	2022-05-31 00:00:00	20	7
BRNRNS61D64G224W	Elettricità	2022-05-26 16:12:23.622	2022-05-31 00:00:00	98	3
FRIFME76P50G224A	Elettricità	2022-05-23 16:12:23.622	2022-05-31 00:00:00	25	2
PRSFNZ86H17G224I	Acqua	2022-05-23 16:12:23.622	2022-05-31 00:00:00	55	8
GLLGNN81A54G224W	Acqua	2022-05-04 16:12:23.622	2022-05-31 00:00:00	57	9
GLLGNN81A54G224W	Elettricità	2022-05-23 16:12:23.622	2022-05-31 00:00:00	50	1
FRIFME76P50G224A	Acqua	2022-05-23 16:12:23.622	2022-05-31 00:00:00	27	2
SPSLRA03M70G224G	Elettricità	2022-05-23 16:12:23.622	2022-05-31 00:00:00	65	7
PRSFNZ86H17G224I	Acqua	2022-05-30 16:12:23.622	2022-05-31 00:00:00	30	6
BRNRNS61D64G224W	Elettricità	2022-05-23 16:12:23.622	2022-05-31 00:00:00	70	9
FRIFME76P50G224A	Gas	2022-05-26 11:14:54	2022-05-31 00:00:00	85	6
PRSFNZ86H17G224I	Gas	2022-05-23 16:12:23.622	2022-05-31 00:00:00	32	4
BRNRNS61D64G224W	Gas	2022-05-23 16:12:23.622	2022-05-31 00:00:00	80	2
SPSLRA03M70G224G	Gas	2022-05-26 11:14:56	2022-05-31 00:00:00	23	7
PRSFNZ86H17G224I	Elettricità	2022-05-23 16:12:23.622	2022-05-31 00:00:00	45	5
\.
...
--
-- Data for Name: imbarcazione; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: molo; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: periodoapertura; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
37	31	2022-07-23 13:02:07.34+00	infinity	\N
32	57	2022-06-23 18:05:05.651+00	infinity	\N
32	62	2022-08-23 18:05:05.651+00	infinity	\N
50	12	2022-11-26 10:45:00.741+00	2022-11-30 10:45:36.93+00	\N
50	12	2023-11-26 10:45:53.562+00	2023-11-30 10:45:36.93+00	\N
50	12	2024-11-26 10:45:53.562+00	2024-11-30 10:45:53.562+00	\N
37	13	2023-05-23 13:02:07.34+00	infinity	25
\.
...
--
-- Data for Name: sosta; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
3	14	2022-05-28 18:32:23.331+00	38	2022-05-29 16:32:49.268+00	4
65	19	2022-05-26 16:53:45.222+00	39	2022-05-29 16:54:14.478+00	2
6	7	2022-05-23 17:52:38.822+00	13	2022-05-24 20:42:59.648+00	11
10	1	2022-05-23 17:26:02.266+00	7	2022-05-26 13:47:05.412+00	5
5	5	2022-05-23 17:51:43.102+00	11	2022-05-26 13:47:05.412+00	5
11	69	2022-05-23 16:12:23.622+00	3	2022-05-26 13:47:05.412+00	5
\.
...
--
-- Name: fattura_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: imbarcazione_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: molo_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: periodoapertura_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: sosta_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.sosta_id_seq', 39, true);


--
-- Name: addetto addetto_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: addetto addetto_servizio_iniziocontratto_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: allacciamento allacciamento_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: aperturaservizio aperturaservizio_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: fattura fattura_cliente_scadenza_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: sosta imbarcazione_gia_in_molo; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: imbarcazione imbarcazione_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: imbarcazione imbarcazione_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: sosta molo_gia_occupato; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: prenotazione molo_gia_prenotato; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: molo molo_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: periodoapertura periodoapertura_giorno_apertura_chiusura_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: periodoapertura periodoapertura_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: sosta sosta_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: sosta sosta_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: idx_molo; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_molo ON public.molo USING btree (lunghezza, larghezza, profonditaminima);


--
-- Name: addetto addetto_persona_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: addetto addetto_servizio_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.addetto
    ADD CONSTRAINT addetto_servizio_fkey FOREIGN KEY (servizio) REFERENCES public.servizio(nome);


--
-- Name: aperturaservizio aperturaservizio_periodoapertura_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: aperturaservizio aperturaservizio_servizio_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: cliente cliente_persona_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: consumo consumo_allacciamento_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: consumo consumo_cliente_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: consumo consumo_fattura_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: fattura fattura_cliente_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: fornitura fornitura_allacciamento_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: fornitura fornitura_molo__fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: imbarcazione imbarcazione_cliente_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: prenotazione prenotazione_cliente_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: prenotazione prenotazione_molo_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: prenotazione prenotazione_sosta_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: sosta sosta_fattura_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: sosta sosta_imbarcazione_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: sosta sosta_molo_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: DATABASE progetto_amassare_fzontaro; Type: ACL; Schema: -; Owner: postgres
--

REVOKE CONNECT,TEMPORARY ON DATABASE progetto_amassare_fzontaro FROM PUBLIC;
GRANT TEMPORARY ON DATABASE progetto_amassare_fzontaro TO PUBLIC;
GRANT ALL ON DATABASE progetto_amassare_fzontaro TO fzontaro;
