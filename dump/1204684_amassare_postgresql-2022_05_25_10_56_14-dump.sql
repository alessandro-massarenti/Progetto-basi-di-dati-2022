...
--
-- Name: libero_ora; Type: VIEW; Schema: public; Owner: amassare
--

CREATE VIEW public.libero_ora AS
 SELECT molo.id,
    molo.occupato,
    molo.profonditaminima,
    molo.larghezza,
    molo.lunghezza,
    molo.prezzogiorno
   FROM public.molo
  WHERE (molo.occupato = false);


ALTER TABLE public.libero_ora OWNER TO amassare;
...
CTTTMS64B16G224U	nord	2022-05-14	\N
...
9099391	38	RSSCTN98M28G224B	fra	Sara	3	BROCELIANDE	5	6	14
...
39	62	2022-05-24 23:54:53.039+00	2022-05-27 23:54:57.889+00	\N
37	48	2022-05-22 17:42:41.2+00	2022-05-28 17:38:01.978+00	\N
32	45	2022-05-21 09:00:00.903+00	2022-05-27 12:01:00.161+00	\N
33	124	2022-05-22 09:00:00.903+00	2022-05-29 12:01:00.161+00	\N
36	125	2022-05-20 17:42:41.2+00	2022-05-30 17:38:01.978+00	\N
2	29	2022-05-10 17:42:41.2+00	2022-05-29 15:38:01.978+00	\N
40	30	2022-05-17 09:00:00.903+00	2022-06-01 12:01:00.161+00	\N
34	14	2022-05-26 17:42:41.2+00	2022-06-03 17:38:01.978+00	\N
38	15	2022-05-18 09:00:00.903+00	2022-06-04 16:01:00.161+00	\N
31	96	2022-05-21 17:42:41.2+00	2022-06-05 17:38:01.978+00	\N
\.
...
--
-- Name: prenotazione molo_gia_impegnato; Type: CONSTRAINT; Schema: public; Owner: amassare
--

ALTER TABLE ONLY public.prenotazione
    ADD CONSTRAINT molo_gia_impegnato EXCLUDE USING gist (int8range((molo)::bigint, (molo)::bigint, '[]'::text) WITH =, box(point(date_part('epoch'::text, timezone('UTC'::text, prevarrivo)), date_part('epoch'::text, timezone('UTC'::text, prevarrivo))), point(date_part('epoch'::text, timezone('UTC'::text, prevpartenza)), date_part('epoch'::text, timezone('UTC'::text, prevpartenza)))) WITH &&);
