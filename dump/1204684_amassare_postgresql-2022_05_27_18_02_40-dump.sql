...
--
-- Name: molo_occupato_rid; Type: VIEW; Schema: public; Owner: amassare
--

CREATE VIEW public.molo_occupato_rid AS
 SELECT sosta.molo,
    sosta.arrivo,
    sosta.partenza
   FROM public.sosta
...
ALTER TABLE public.molo_occupato_rid OWNER TO amassare;

--
-- Name: molo_libero_da_rid; Type: VIEW; Schema: public; Owner: amassare
--

CREATE VIEW public.molo_libero_da_rid AS
 SELECT sosta.molo,
    sosta.arrivo AS libero_da
   FROM public.sosta
  WHERE ((NOT (sosta.molo IN ( SELECT molo_occupato_rid.molo
           FROM public.molo_occupato_rid))) AND (sosta.partenza < timezone('Europe/Rome'::text, now())));


ALTER TABLE public.molo_libero_da_rid OWNER TO amassare;

--
-- Name: molo_libero_fino_a_rid; Type: VIEW; Schema: public; Owner: amassare
--

CREATE VIEW public.molo_libero_fino_a_rid AS
 SELECT sosta.molo,
    sosta.arrivo AS libero_fino_a
   FROM public.sosta
  WHERE ((NOT (sosta.molo IN ( SELECT molo_occupato_rid.molo
           FROM public.molo_occupato_rid))) AND (sosta.arrivo > timezone('Europe/Rome'::text, now())));


ALTER TABLE public.molo_libero_fino_a_rid OWNER TO amassare;

--
-- Name: libero_adesso_rid; Type: VIEW; Schema: public; Owner: amassare
--

CREATE VIEW public.libero_adesso_rid AS
 SELECT COALESCE(molo_libero_da_rid.molo, mlfa.molo) AS molo,
   ...
   FROM (public.molo_libero_da_rid
     FULL JOIN public.molo_libero_fino_a_rid mlfa ON ((molo_libero_da_rid.molo = mlfa.molo)))
  GROUP BY molo_libero_da_rid.molo, mlfa.molo;


ALTER TABLE public.libero_adesso_rid OWNER TO amassare;
...
--
-- Name: moli_liberi; Type: VIEW; Schema: public; Owner: amassare
--

CREATE VIEW public.moli_liberi AS
 SELECT molo.id AS molo,
    libero_adesso_rid.libero_da,
    libero_adesso_rid.libero_fino_a,
    molo.occupato AS occupato_ora
   FROM (public.molo
     LEFT JOIN public.libero_adesso_rid ON ((libero_adesso_rid.molo = molo.id)));


ALTER TABLE public.moli_liberi OWNER TO amassare;
...
--
-- Name: addetto addetto_servizio_fkey; Type: FK CONSTRAINT; Schema: public; Owner: amassare
--
...
--
-- Name: DATABASE progetto_amassare_fzontaro; Type: ACL; Schema: -; Owner: amassare
--
