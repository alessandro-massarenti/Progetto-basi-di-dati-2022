...
\textbf{Prenotazione} (\underline{\textit{cliente, prevArrivo, molo}}, prevPartenza, stato);

\textbf{Sosta} (\underline{\textit{imbarcazione, molo, arrivo}}, partenza, fattura);
...
\textbf{Fattura}(\underline{\textit{cliente, scadenza}}, pagato);\\
