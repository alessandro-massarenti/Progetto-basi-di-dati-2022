...
Imbarcazione(\underline{codiceInternazionale}, \underline{id} bandiera, nome capitano, qtpostiletto, nome, dimensioni, pescaggio, larghezza, LOA);
...
Addetto(\underline{servizio}, \underline{Servizio, dataInizioContratto}, dataFineContratto);
