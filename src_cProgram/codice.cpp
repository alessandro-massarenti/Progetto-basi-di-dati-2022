        ...
        if(q < 0 || q > 5){
            ...
            switch (q) {
                case(4):{
                    ...
                    ResultTable rt(PQexecPrepared(conn,"q1",1,&parameter,0,0,0));
                    std::cout << rt;
                    break;
                }
                case(5):{
            ...
            std::cin >> q;
            if(q != 0 && q != 1) std::cout << "Va bene comunque, torno comunque al principale\n";
        }
    }
